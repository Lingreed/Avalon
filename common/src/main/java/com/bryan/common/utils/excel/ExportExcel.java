package com.bryan.common.utils.excel;

import com.bryan.common.utils.DictUtil;
import com.bryan.common.utils.Encodes;
 ...
 * Function:导出Excel文件（导出“XLSX”格式，支持大数据量导出）
 *
 * @author Bryan.Lin
 * @version 1.0
 * @date 2018/3/1
            ...
            for (Object[] os : annotationList) {
                ...
                try {
                    ...
                    if (StringUtils.isNotBlank(ef.dictType())) {
                        val = DictUtil.getDictValue(ef.dictType(), val==null?"":val.toString());
                    }
                } catch (Exception ex) {
                    // Failure to ignore
