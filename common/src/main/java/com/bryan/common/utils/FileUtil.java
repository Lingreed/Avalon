...
/**
 * ClassName: FileUtils  
 * Function:  文件操作工具类 实现文件的创建、删除、复制、压缩、解压以及目录的创建、删除、复制、压缩解压等功能
 * @Author zhouxuecheng
 * @Version v1.0.0
 * @Date 2017年12月22日 下午3:59:37
...
public class FileUtil extends org.apache.commons.io.FileUtils {
	...
	/*
	 * protected static int topValue = 10; protected static int leftValue = 20;
	 * protected static int rightValue = 10; protected static int bottomValue =
	 * 10; protected static int userSpaceWidth = 1300;
	 * 
	 * public static byte[] doConversion2(String htmlDocument) throws
	 * InvalidParameterException, MalformedURLException, IOException { PD4ML
	 * pd4ml = new PD4ML(); pd4ml.setHtmlWidth(userSpaceWidth);
	 * pd4ml.setPageSize(pd4ml.changePageOrientation(PD4Constants.A4));
	 * pd4ml.setPageInsetsMM(new Insets(topValue, leftValue, bottomValue,
	 * rightValue)); pd4ml.addStyle("BODY {margin: 0}", true);
	 * pd4ml.enableDebugInfo();
	 * 
	 * ByteArrayOutputStream baos = new ByteArrayOutputStream();
	 * pd4ml.render(new StringReader(htmlDocument), baos); baos.close(); String
	 * str = new String(baos.toByteArray(),"iso-8859-1");
	 * System.out.println(str); return baos.toByteArray(); }
	 */
